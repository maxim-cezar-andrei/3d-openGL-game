...
Obiect obiecte[] = {
	...
	// === ZONA 3: Zigzag ===
	{glm::vec3(-2.5f, 1.0f, -71.0f), glm::vec3(45.0f, 3.0f, 1.0f), WALL},  // deschidere dreapta X=20 la X=25
	{glm::vec3( 2.5f, 1.0f, -87.0f), glm::vec3(45.0f, 3.0f, 1.0f), WALL},  // deschidere stanga X=-25 la X=-20
	// Obstacole mobile pe Z
	{glm::vec3(  0.0f, 0.5f, -72.5f), glm::vec3(1.0f, 3.0f, 1.0f), UNSAFE, 0.0f, 0.0f, 0.0f,  0.08f, -86.0f, -72.0f},
	{glm::vec3(  8.0f, 0.5f, -75.0f), glm::vec3(1.0f, 3.0f, 1.0f), UNSAFE, 0.0f, 0.0f, 0.0f, -0.06f, -86.0f, -72.0f},
	{glm::vec3( -8.0f, 0.5f, -79.0f), glm::vec3(1.0f, 3.0f, 1.0f), UNSAFE, 0.0f, 0.0f, 0.0f,  0.10f, -86.0f, -72.0f},
	{glm::vec3(  4.0f, 0.5f, -82.0f), glm::vec3(1.0f, 3.0f, 1.0f), UNSAFE, 0.0f, 0.0f, 0.0f, -0.07f, -86.0f, -72.0f},
	{glm::vec3( -4.0f, 0.5f, -85.0f), glm::vec3(1.0f, 3.0f, 1.0f), UNSAFE, 0.0f, 0.0f, 0.0f,  0.05f, -86.0f, -72.0f},

	// === PORTAL FINISH ===
	{glm::vec3(0.0f, 1.0f, -98.0f), glm::vec3(3.0f, 3.0f, 0.5f), FINISH}
};
...
void updateLevel()
{
	for (int i = 0; i < nrObstacole; i++)
	{
		...
		{
			obiecte[i].pozitie.z += obiecte[i].vitezaZ;
